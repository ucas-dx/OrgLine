...
orgdet track model=yolov8n.pt source="https://youtu.be/LNwODJXcvt4"  # Official Detect model
orgdet track model=yolov8n-seg.pt source="https://youtu.be/LNwODJXcvt4"  # Official Segment model
orgdet track model=yolov8n-pose.pt source="https://youtu.be/LNwODJXcvt4"  # Official Pose model
orgdet track model=path/to/best.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
orgdet track model=path/to/best.pt tracker="bytetrack.yaml"
```
...
orgdet track model=yolov8n.pt source="https://youtu.be/LNwODJXcvt4" conf=0.3, iou=0.5 show
```
...
orgdet track model=yolov8n.pt source="https://youtu.be/LNwODJXcvt4" tracker='custom_tracker.yaml'
```
