...
from orgline.utils.metrics import OKS_SIGMA
from orgline.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from orgline.utils.tal import TaskAlignedAssigner, dist2bbox, make_anchors
from orgline.utils.atss import ATSSAssigner, generate_anchors
...
class v8SegmentationLoss(v8DetectionLoss):
    ...
    def __call__(self, preds, batch):
        """Calculate and return the loss for the ORGDET model."""
        ...
        try:
            ...
            raise TypeError('ERROR ❌ segment dataset incorrectly formatted or not a segment dataset.\n'
                            ...
                            "i.e. 'ORGDET train model=ORGDETv8n-seg.pt data=coco128.yaml'.\nVerify your dataset is a "
                            "correctly formatted 'segment' dataset using 'data=coco128-seg.yaml' "
                            'as an example.\nSee https://docs.orgline.com/tasks/segment/ for help.') from e
