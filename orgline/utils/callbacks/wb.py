...
from orgline.utils import SETTINGS, TESTS_RUNNING
...
def on_pretrain_routine_start(trainer):
    ...
    wb.run or wb.init(project=trainer.args.project or 'ORGDETv8', name=trainer.args.name, config=vars(trainer.args))
