...
from orgline.utils import LOGGER, SETTINGS, TESTS_RUNNING, checks
...
def on_pretrain_routine_start(trainer):
    ...
    try:
        ...
        LOGGER.info("DVCLive is detected and auto logging is enabled (run 'ORGDET settings dvc=False' to disable).")
