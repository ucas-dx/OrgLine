...
from orgline.utils.tal import TORCH_1_10, dist2bbox, make_anchors
...
class Pose(Detect):
    """ORGDETv8 Pose head for keypoints models."""

    def __init__(self, nc=80, kpt_shape=(17, 3), ch=()):
        """Initialize ORGDET network with default parameters and Convolutional Layers."""
        super().__init__(nc, ch)
    ...
    def forward(self, x):
        """Perform forward pass through ORGDET model and return predictions."""
...
class Classify(nn.Module):
    """ORGDETv8 classification head, i.e. x(b,c1,20,20) to x(b,c2)."""

    def __init__(self, c1, c2, k=1, s=1, p=None, g=1):
        """Initializes ORGDETv8 classification head with specified input and output channels, kernel size, stride,
        padding, and groups.
        """
        super().__init__()
    ...
    def forward(self, x):
        """Performs a forward pass of the ORGDET model on input image data."""
...
class RTDETRDecoder(nn.Module):
    ...
    def forward(self, x, batch=None):
        ...
        from orgline.models.utils.ops import get_cdn_group
