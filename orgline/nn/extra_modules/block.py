...
from .orepa import *
from .RFAConv import *
from orgline.utils.torch_utils import make_divisible
from timm.layers import trunc_normal_

__all__ = ['DyHeadBlock', 'Fusion', 'C2f_Faster', 'C3_Faster', 'C3_ODConv', 'C2f_ODConv', 'Partial_conv3', 'C2f_Faster_EMA', 'C3_Faster_EMA', 'C2f_DBB',
           'GSConv', 'VoVGSCSP', 'VoVGSCSPC', 'C2f_CloAtt', 'C3_CloAtt', 'SCConv', 'C3_SCConv', 'C2f_SCConv', 'ScConv', 'C3_ScConv', 'C2f_ScConv',
           'LAWDS', 'EMSConv', 'EMSConvP', 'C3_EMSC', 'C3_EMSCP', 'C2f_EMSC', 'C2f_EMSCP', 'RCSOSA', 'DCNv2', 'C3_DCNv2', 'C2f_DCNv2',  'FocalModulation',
...
class Bottleneck_CloAtt(Bottleneck):
    ...
    def forward(self, x):
        """'forward()' applies the ORGDETv5 FPN to input data."""
...
class GOLDORGDET_Attention(torch.nn.Module):
...
class top_Block(nn.Module):
    ...
    def __init__(self, dim, key_dim, num_heads, mlp_ratio=4., attn_ratio=2., drop=0.,
        ...
        self.attn = GOLDORGDET_Attention(dim, key_dim=key_dim, num_heads=num_heads, attn_ratio=attn_ratio)
