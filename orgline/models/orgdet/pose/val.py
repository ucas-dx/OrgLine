...
from orgline.utils.metrics import OKS_SIGMA, PoseMetrics, box_iou, kpt_iou
...
class PoseValidator(DetectionValidator):
    ...
    Example:
        ```python
        from orgline.models.ORGDET.pose import PoseValidator

        args = dict(model='ORGDETv8n-pose.pt', data='coco8-pose.yaml')
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        ...
        if isinstance(self.args.device, str) and self.args.device.lower() == 'mps':
            LOGGER.warning("WARNING ⚠️ Apple MPS known Pose bug. Recommend 'device=cpu' for Pose models. "
                           'See https://github.com/orgline/orgline/issues/4031.')
    ...
    def init_metrics(self, model):
        """Initiate pose estimation metrics for ORGDET model."""
    ...
    def plot_predictions(self, batch, preds, ni):
        """Plots predictions for ORGDET model."""
    ...
    def pred_to_json(self, predn, filename):
        """Converts ORGDET predictions to COCO JSON format."""
