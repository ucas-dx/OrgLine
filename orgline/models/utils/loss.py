...
from orgline.utils.loss import FocalLoss, VarifocalLoss
from orgline.utils.metrics import bbox_iou
...
class DETRLoss(nn.Module):
    ...
    def _get_loss_class(self, pred_scores, targets, gt_scores, num_gts, postfix=''):
        ...
        if self.fl:
            ...
            loss_cls = nn.BCEWithLogitsLoss(reduction='none')(pred_scores, gt_scores).mean(1).sum()  # ORGDET CLS loss
