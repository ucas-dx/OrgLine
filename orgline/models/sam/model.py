...
This module provides an interface to the Segment Anything Model (SAM) from orgline, designed for real-time image
...
from orgline.utils.torch_utils import model_info
