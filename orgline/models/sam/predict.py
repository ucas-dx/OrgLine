...
using SAM. It forms an integral part of the orgline framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from orgline.data.augment import LetterBox
from orgline.engine.predictor import BasePredictor
from orgline.engine.results import Results
from orgline.utils import DEFAULT_CFG, ops
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model, verbose=True):
        ...
        parameters for image normalization and other orgline compatibility settings.
        ...
        # orgline compatibility settings
        self.model.pt = False
